    ...
    <div class="px-2 w-full">
        ...
        <div class="mt-10">
            ...
            <div class="mt-2 text-sm space-x-1 space-y-1">
                ...
                ><span>
                    {{ obsStudent.firstname }} {{ obsStudent.lastname }}

                </span>
                <IconX class="w-3 text-gray-200"/></button>
            </div>
            <input
        ...
        <div class="mt-10">
            <CompetenciesSelector @selected="selectCompetency" :socle="socle" cycle="c2"/>
        </div>
        <div class="mt-8">
...
import CompetenciesSelector from './CompetenciesSelector.vue'
...
const obsStudentsFull = computed(() => props.students
    .filter(student => obsStudents.value.indexOf(student.id) !== -1)
)
...
const socleFiltered = computed(() => props.socle
    .filter()
)
